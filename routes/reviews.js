 ...
 *         id_fasilitas:
 *           type: integer
 *           description: ID fasilitas (pendidikan atau kesehatan) yang direview
 *         tipe_fasilitas:
 *           type: string
 *           enum: [FasilitasPendidikan, FasilitasKesehatan]
 *           description: Tipe fasilitas yang direview (FasilitasPendidikan atau FasilitasKesehatan)
 *     Review:
 *       allOf:
